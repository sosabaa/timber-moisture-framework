...
![Conceptual framework for reuse-informed moisture sensing and data acquisition in mass-timber buildings, with supporting literature identified for each layer.](assets/framework_with_supporting_literature.png)
